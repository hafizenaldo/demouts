import 'package:demouts/model/model_profile.dart';
import 'package:demouts/utils/lat_session_manager.dart';
  ...
  Future<ModelProfile?> updateAccount() async {
    ...
    try {
      ...
      http.Response response = await http.post(
          Uri.parse('http://192.168.100.239/edukasi_server/updateUser.php'),
          body: {
